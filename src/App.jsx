...
export default function App() {
    ...
    for(let i = 0; i < trajectories.length; i++){
      ...
      if(trajectories[i] && trajectories[i]['end']['x'] != undefined && trajectories[i]['end']['x'] > 0){
        ...
        for(let j = 0; j < trajectories[i]["translation"].length; j++){
          ...
          if(tr == ""){
            xa += `def Trajectory${trajectories[i]['id']}Blue():
            trueValue = [self.s_Intake.getIntakeBeamBreakState, self.s_Indexer.getBeamBreakState]
            if(trueValue == [0,0]):
                if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0] == "continue"}):
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                ...
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0] == "shot"}):
                    return SequentialCommandGroup(self.dynamicShot(), InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${trajectories[i]['end']['x']}, ${trajectories[i]['end']['y']}, Rotation2d.fromDegrees(${trajectories[i]['end']['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand))
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].includes("divert")}):
                    self.conditionalLast = ${parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", ""))}
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", "")):0]['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
            elif(trueValue == [0,1]):
                if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1] == "continue"}):
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${trajectories[i]['end']['x']}, ${trajectories[i]['end']['y']}, Rotation2d.fromDegrees(${trajectories[i]['end']['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1] == "shot"}):
                    return SequentialCommandGroup(self.dynamicShot(), InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${trajectories[i]['end']['x']}, ${trajectories[i]['end']['y']}, Rotation2d.fromDegrees(${trajectories[i]['end']['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand))
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].includes("divert")}):
                    self.conditionalLast = ${parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", ""))}
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", "")):0]['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
            elif(trueValue == [1,0]):
                if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2] == "continue"}):
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${trajectories[i]['end']['x']}, ${trajectories[i]['end']['y']}, Rotation2d.fromDegrees(${trajectories[i]['end']['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2] == "shot"}):
                    return SequentialCommandGroup(self.dynamicShot(), InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${trajectories[i]['end']['x']}, ${trajectories[i]['end']['y']}, Rotation2d.fromDegrees(${trajectories[i]['end']['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand))
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].includes("divert")}):
                    self.conditionalLast = ${parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", ""))}
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
            elif(trueValue == [1,1]):
                if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3] == "continue"}):
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${trajectories[i]['end']['x']}, ${trajectories[i]['end']['y']}, Rotation2d.fromDegrees(${trajectories[i]['end']['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3] == "shot"}):
                    return SequentialCommandGroup(self.dynamicShot(), InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${trajectories[i]['end']['x']}, ${trajectories[i]['end']['y']}, Rotation2d.fromDegrees(${trajectories[i]['end']['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand))
                elif(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].includes("divert")}):
                    self.conditionalLast = ${parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))}
                    return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                        Pose2d(${trajectories[i]['start']['x']}, ${trajectories[i]['start']['y']}, Rotation2d.fromDegrees(${trajectories[i]['start']['theta']})),
                        Pose2d(${targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['theta']})),
                        config
                    ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
                \n        `
          }
      ...
      for(let i = 0; i < trajblr.length; i++){
        ...
        if(trajblr[i] && trajblr[i]['end']['x'] != undefined && trajblr[i]['end']['x'] > 0){
          ...
          for(let j = 0; j < trajblr[i]["translation"].length; j++){
            ...
            if(tr == ""){
              xa += `def Trajectory${trajblr[i]['id']}Red():
              trueValue = [self.s_Intake.getIntakeBeamBreakState, self.s_Indexer.getBeamBreakState]
              if(trueValue == [0,0]):
                  if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0] == "continue"}):
                      return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                      ...
                      return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                          Pose2d(${trajblr[i]['start']['x']}, ${trajblr[i]['start']['y']}, Rotation2d.fromDegrees(${trajblr[i]['start']['theta']})),
                          Pose2d(${16.541052-targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${180-targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0].replace("divert", "")):0]['theta']})),
                          config
                      ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
              elif(trueValue == [0,1]):
                  if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1] == "continue"}):
                      ...
                      return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                          Pose2d(${trajblr[i]['start']['x']}, ${trajblr[i]['start']['y']}, Rotation2d.fromDegrees(${trajblr[i]['start']['theta']})),
                          Pose2d(${16.541052-targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${180-targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][1].replace("divert", "")):0]['theta']})),
                          config
                      ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
              elif(trueValue == [1,0]):
                  if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2] == "continue"}):
                      ...
                      return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                          Pose2d(${trajblr[i]['start']['x']}, ${trajblr[i]['start']['y']}, Rotation2d.fromDegrees(${trajblr[i]['start']['theta']})),
                          Pose2d(${16.541052-targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${180-targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][2].replace("divert", "")):0]['theta']})),
                          config
                      ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
              elif(trueValue == [1,1]):
                  if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3] == "continue"}):
                      ...
                      return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                          Pose2d(${trajblr[i]['start']['x']}, ${trajblr[i]['start']['y']}, Rotation2d.fromDegrees(${trajblr[i]['start']['theta']})),
                          Pose2d(${16.541052-targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${180-targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['theta']})),
                          config
                      ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
                  \n        `
            }
            else{
              xa += `def Trajectory${trajectories[i]['id']}Red():
              trueValue = [self.s_Intake.getIntakeBeamBreakState, self.s_Indexer.getBeamBreakState]
              if(trueValue == [0,0]):
                  if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0] == "continue"}):
                      return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                ...
                if(trueValue == [0,0]):
                    ...
                    if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3] == "continue"}):
                        ...
                        return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                            ...
                            Pose2d(${targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['theta']})),
                            config
                        ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand).initialPose())
                    \n        `
              }
            }
          }
          ...
          for(let i = 0; i < trajblr.length; i++){
            ...
            if(trajblr[i] && trajblr[i]['end']['x'] != undefined && trajblr[i]['end']['x'] > 0){
              ...
              for(let j = 0; j < trajblr[i]["translation"].length; j++){
                ...
                if(tr == ""){
                  xa += `def Trajectory${trajblr[i]['id']}Blue():
                  trueValue = [self.s_Intake.getIntakeBeamBreakState, self.s_Indexer.getBeamBreakState]
                  if(trueValue == [0,0]):
                      if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][0] == "continue"}):
                          return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory( #${Math.round(distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*1000)/1000}m (${Math.round((distance(data.start.x, data.start.y, data.end.x, data.end.y, data.translation)*2/7.6)*1000)/1000}sec)
                  ...
                  if(trueValue == [0,0]):
                      ...
                      if(${targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3] == "continue"}):
                          ...
                          return InstantCommand(lambda: self.s_Swerve.setPose(TrajectoryGenerator.generateTrajectory(
                              ...
                              Pose2d(${16.541052-targets[((parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")))?(parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))):(0))]['x']}, ${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['y']}, Rotation2d.fromDegrees(${targets[parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", ""))?parseInt(targets[trajectories[i]["id"]+amountTranslationBefore(i)]["continueAsPlanned"][3].replace("divert", "")):0]['theta']-180})),
                              config
                          ).initialPose()), (self.s_Swerve,)).andThen(self.swerveControllerCommand), (self.s_Swerve,)).andThen(self.swerveControllerCommand)
                      \n        `
                }
              }
            }
  ...
  function tras2(){
    ...
    for(let i = 0; i < trajectories.length; i++){
      ...
      if(trajectories[i] && trajectories[i]['end']['x'] != undefined && trajectories[i]['end']['x'] > 0){
          xa += `            SequentialCommandGroup(delay(${targets[trajectories[i]["id"]]?.delay}),
              (self.Trajectory${trajectories[i]['id']}Red() if self.s_Swerve.shouldFlipPath else self.Trajectory${trajectories[i]['id']}Blue()) if (${trajectories[i]['id']} > self.conditionalLast) else (self.doNothing())
            ),\n`
        }
      }
          return xa;
